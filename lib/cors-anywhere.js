...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://abfstg.sharepoint.com/sites/ABFI','https://localhost:4321/temp/workbench.html','https://abfoods.sharepoint.com/sites/abi-pulse', 'https://localhost:4321/'],            // If non-empty, requests not from an origin in this list will be blocked.
